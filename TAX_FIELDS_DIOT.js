                ...
                if (context.type == context.UserEventType.CREATE || context.type == context.UserEventType.EDIT) {
                    ...
                    if (concuenta) {
                        ...
                        if (factEspejo != true || (factEspejo == true && tipogbl == 2)) {
                            ...
                            var aux_rate_desccabecera = 0;

                            if (descuentoglobal) {
                                rate_desccabecera = ((descuentoglobal * 100) / subtotalTran).toFixed(2);
                                aux_rate_desccabecera = ((descuentoglobal * 100) / subtotalTran).toFixed(2);
                            ...
                            for (var i = 0; i < line_count; i++) {
                                ...
                                if (descuentoglobal) {
                                    descuento_notax = (importe_base * aux_rate_desccabecera) * -1;
                                ...
                                if (descuentoglobal && rate_desccabecera) {
                                    obj_Json_Tax.descuentoConImpuesto = ((importe_base * aux_rate_desccabecera)/100).toFixed(2);
                                    obj_Json_Tax.descuentoSinImpuesto = ((importe_base * aux_rate_desccabecera)/100).toFixed(2);
                                    log.audit({title:'obj_Json_Tax.descuentoConImpuesto 🦕',details:obj_Json_Tax.descuentoConImpuesto});
                                    log.audit({title:'aux_rate_desccabecera 🦕',details:aux_rate_desccabecera});
                                    log.audit({title:'importe_base 🦕',details:importe_base});
                                    ...
                                    if (tam_rates_iva > 0) {
                                        for (var t = 0; t < tam_rates_iva; t++) {
                                            if (Object.keys(obj_Json_Tax_totales.rates_iva)[t] == cadena_rate) {
                                                ...
                                                log.debug({title:"TYPEOF 1", details:typeof base_iva_total});
                                                ...
                                                obj_Json_Tax_totales.rates_iva[cadena_rate] = parseFloat(obj_iva_total).toFixed(2);
                                                obj_Json_Tax_totales.rates_iva_data[obj_Json_Tax.iva.rate] = parseFloat(obj_iva_total).toFixed(2);
                            ...
                            obj_Json_Tax_totales.totalImpuestos = parseFloat(obj_Json_Tax_totales.totalImpuestos)+parseFloat(enviototalimpuesto);
                            obj_Json_Tax_totales.totalImpuestos = parseFloat(obj_Json_Tax_totales.totalImpuestos.toFixed(2));
                            obj_Json_Tax_totales.totalImpuestos_gbl = parseFloat(obj_Json_Tax_totales.totalImpuestos_gbl)+parseFloat(enviototalimpuesto);
                            obj_Json_Tax_totales.iva_total = parseFloat(obj_Json_Tax_totales.iva_total)+parseFloat(enviototalimpuesto);
                            log.audit({ title: 'total Iva👻', details: enviototalimpuesto });
                            obj_Json_Tax_totales.iva_total = parseFloat(obj_Json_Tax_totales.iva_total.toFixed(2));
